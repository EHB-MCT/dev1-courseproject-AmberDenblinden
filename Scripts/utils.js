...
/**
 * Draws a filled ellipse of which the center is at x, y
...
/**
 * Draws a filled circle of which the center is at x, y
 * @param {*} x x coordinate of the center of the circle
 * @param {*} y y coordinate of the center of the circle
 * @param {*} rX horizontal radius of the circle (half of the width)
 */
